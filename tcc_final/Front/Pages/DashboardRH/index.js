const registerUserButton = document.querySelector("#registerButton");
const registerHolerite = document.querySelector("#registerHolerite");

registerUserButton.addEventListener("click", () => {
  window.location.href = "./Form/form.html";
});
registerHolerite.addEventListener("click", () => {
  window.location.href = "./Holerite/index.html";
});
...
//logout
const logoutBtn = document.querySelector(".back-button");
